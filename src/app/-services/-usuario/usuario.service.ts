...
export class UsuarioService extends BaseService {
  ...
  constructor(
    ...
    this._url = this._uriService.obterUrlApi() +"/Usuario";
  ...
  listarPorEmpresa(idEmpresa:number){
    return this._http.get(this._url + "/ListarPorEmpresa/" + idEmpresa, this._reqOptions)
    .map(resp => resp.json()).catch(ex => this.tratarErro(ex));
  }
